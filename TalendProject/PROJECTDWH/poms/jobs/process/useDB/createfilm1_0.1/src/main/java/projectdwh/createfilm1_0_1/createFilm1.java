...
package projectdwh.createfilm1_0_1;
...
/**
 * Job: createFilm1 Purpose: create<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class createFilm1 implements TalendJob {
	...
	private final String jobName = "createFilm1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(createFilm1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJECTDWH_createFilm1 = new byte[0];
		static byte[] commonByteArray_PROJECTDWH_createFilm1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECTDWH_createFilm1.length) {
					if (length < 1024 && commonByteArray_PROJECTDWH_createFilm1.length == 0) {
						commonByteArray_PROJECTDWH_createFilm1 = new byte[1024];
					} else {
						commonByteArray_PROJECTDWH_createFilm1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECTDWH_createFilm1, 0, length);
				strReturn = new String(commonByteArray_PROJECTDWH_createFilm1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJECTDWH_createFilm1, 0, length);
				strReturn = new String(commonByteArray_PROJECTDWH_createFilm1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECTDWH_createFilm1) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "dim_film";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:JW5+ragU08rKkG9rdcDxNHDpznrN/VzE2B+S+Q==");
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`imdb_id` VARCHAR(9)  ,`popularity` FLOAT(20,15)  ,`original_title` VARCHAR(200)  ,`runtime` FLOAT(10,3)  ,`genres` VARCHAR(47)  ,primary key(`imdb_id`))");
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "dim_film"
						+ "` (`imdb_id`,`popularity`,`original_title`,`runtime`,`genres`) VALUES (?,?,?,?,?)";
...
// # Output table : 'out1'
									out1_tmp.imdb_id = row1.imdb_id;
									out1_tmp.popularity = row1.popularity;
									out1_tmp.original_title = row1.original_title;
...
// Start of branch "out1"
								if (out1 != null) {
									...
									row2 = null;
									if (out1.imdb_id == null) {
										finder_tUniqRow_1.imdb_id = null;
									} else {
										finder_tUniqRow_1.imdb_id = out1.imdb_id.toLowerCase();
									}
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										if (out1.imdb_id == null) {
											...
											new_tUniqRow_1.imdb_id = out1.imdb_id.toLowerCase();
										}
										...
										row2.imdb_id = out1.imdb_id;
										row2.popularity = out1.popularity;
										row2.original_title = out1.original_title;
										row2.runtime = out1.runtime;
										row2.genres = out1.genres;
...
// Start of branch "row2"
									if (row2 != null) {
										...
										if (row2.imdb_id == null) {
											...
											pstmt_tDBOutput_1.setString(1, row2.imdb_id);
										}

										if (row2.popularity == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.FLOAT);
										} else {
											pstmt_tDBOutput_1.setFloat(2, row2.popularity);
										}
										...
										if (row2.runtime == null) {
											...
											pstmt_tDBOutput_1.setFloat(4, row2.runtime);
										}
...
// ###############################      
	...
	public static void main(String[] args) {
		final createFilm1 createFilm1Class = new createFilm1();

		int exitCode = createFilm1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = createFilm1.class.getClassLoader()
					.getResourceAsStream("projectdwh/createfilm1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = createFilm1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : createFilm1");
		}
...
/************************************************************************************************
 * 112206 characters generated by Talend Open Studio for Data Integration on the
 * 6 décembre 2024, 07:47:17 WAT
 ************************************************************************************************/